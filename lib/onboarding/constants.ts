...
export const FEATURE_AREA_CONFIG: Record<FeatureAreaId, FeatureAreaConfig> = {
  spending: {
    ...
    activateHint: 'Ativa para perceberes para onde vai o dinheiro',
  },
  goals: {
    id: 'goals',
    emoji: '🎯',
    ...
    activateHint: 'Ativa para acompanhar as tuas metas',
  },
  wealth: {
    id: 'wealth',
    emoji: '📈',
    ...
    activateHint: 'Ativa para acompanhar os teus bens',
  },
  receipts: {
    id: 'receipts',
    emoji: '🧾',
    ...
    activateHint: 'Ativa para nunca perderes uma garantia',
  },
  subscriptions: {
    id: 'subscriptions',
    emoji: '📱',
    ...
    activateHint: 'Ativa para controlar subscrições',
  },
  credits: {
    id: 'credits',
    emoji: '🏦',
    ...
    activateHint: 'Ativa para ter visibilidade sobre dívidas',
  },
};
