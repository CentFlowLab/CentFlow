/** Edge Function copy — manter em sync com lib/merchant/fuzzy-match.ts */
...
function scoreMerchantMatch(description: string, candidate: string): number {
...
function inferCategoryFromMerchantText(merchant?: string): string {
